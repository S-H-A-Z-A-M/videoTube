...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  const oldAvatarImage = await User.findById(req.user?._id).select("avatar");
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  const oldAvatarImage = await User.findById(req.user._id).select("coverImage");
  ...
  const deletedResponse = await DeleteCloudinaryAsset(oldAvatarImage);
